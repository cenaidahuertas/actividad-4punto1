public class Cliente {
    ...
    public void setDireccion(String valor) {
        valor = valor.trim();
        if (valor.isEmpty()) throw new IllegalArgumentException("La direccion no puede estar vacia.");
    ...
    public String presentarQueja(String mensaje) {
        ...
        if (mensaje.isEmpty()) throw new IllegalArgumentException("La queja no puede estar vacia.");
