 ...
 * Gestiona la información del pedido, su estado y permite cambios de estado.
 */
public class Pedido {
    ...
    public void cambiarEstado(EstadoPedido nuevoEstado) {
        if (nuevoEstado == null) {
            throw new IllegalArgumentException("Estado null.");
        }
        this.estado = nuevoEstado;
    }

    /**
     * Intenta cancelar el pedido. Solo puede cancelarse si está pendiente o confirmado.
     *
